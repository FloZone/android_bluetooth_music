...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        final AlertDialog dialogReset = new AlertDialog.Builder(getActivity())
        ...
        View dialogview = getActivity().getLayoutInflater().inflate(R.layout.dialog_tuto, null);
        ...
        findPreference(Preferences.KEY_VERSION).setSummary(AppUtils.getAppVersion(getActivity()));
        ...
        findPreference(Preferences.KEY_LICENSE).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                ArrayAdapter<Triple> adapter = new ArrayAdapter<Triple>(getActivity(), android.R.layout.simple_list_item_2, android.R.id.text1, licensesList) {
                    @NonNull
                    @Override
